...
const Footer = () => {
  ...
  const handleNewsletterSubmit = async (e) => {
    ...
    try {
      ...
      await subscribeToNewsletter(email, 'footer_signup');
  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { href: '/contact?subject=Impact%20report%20request', label: 'Request Impact Reports' },
        { href: '/contact?subject=Financial%20information', label: 'Request Financial Information' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              {socialLinks.filter(social => /^https:\/\//.test(social.href)).map((social) => (
                <a
                  key={social.name}
                  href={social.href}
        ...
        <div className="pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex flex-wrap justify-center md:justify-end space-x-6 text-sm">
              <Link href="/contact" className="text-gray-400 hover:text-teal-300">Contact & Enquiries</Link>
              <Link href="/sitemap" className="text-gray-400 hover:text-teal-300">Sitemap</Link>
            </div>
          </div>
